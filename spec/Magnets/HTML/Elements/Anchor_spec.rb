...
describe ::Magnets::HTML::Elements::Anchor do
  ...
  it 'can be initialized with link text' do
    ...
    link = ::Magnets::HTML::Elements::Anchor.new( link_text )
  ...
  it 'can be initialized with link text and url' do
    ...
    link = ::Magnets::HTML::Elements::Anchor.new( link_text, link_url )
  ...
  it 'can render an HTML anchor with a URI (<a href="...://..."...>)' do
    ...
    link = ::Magnets::HTML::Elements::Anchor.new
