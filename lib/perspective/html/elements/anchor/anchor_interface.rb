...
module ::Perspective::HTML::Elements::Anchor::AnchorInterface
  ...
  def to_html_node( document = «initialize_document», view_rendering_empty = @«view_rendering_empty» )
    ...
    if optimal_media_value = optimal_media
    ...
    self_as_html_node.content = text.to_s
  ...
  ##############
	...
	#  return ::Perspective::HTML::Elements::Anchor::Languages.has_key?( language_code )
  #end
  #
  #target.validate do |target_value|
	#  return ::Perspective::HTML::Elements::Anchor::Targets.has_key?( language_code )
  #end
  #
  #target.validate do |relationship_value|
	#  return ::Perspective::HTML::Elements::Anchor::Relationships.has_key?( relationship_value )
  #end
