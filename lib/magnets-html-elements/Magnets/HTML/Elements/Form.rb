...
class ::Magnets::HTML::Elements::Form
  ...
  ::Magnets::Bindings::Attributes.define_container_type( :HTML_form_element, :HTML_view ) do

    base = ::Magnets::HTML::Elements::Form::Input
  ...
  extend ::Magnets::Bindings::AttributeContainer::HTMLFormElement
